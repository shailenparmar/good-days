...
export const ABOUT_COPY = {
  ...
  system: {
    header: "system:",
    paragraphs: [
      "entries are unaffected by refreshing, closing, and quitting. however, manually deleting site data in browser settings clears the app.",
      "good days is optimized for chromium. safari automatically deletes localstorage after 7 days of inactivity.",
    ],
  },
