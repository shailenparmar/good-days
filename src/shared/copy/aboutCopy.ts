...
export const ABOUT_COPY = {
  ...
  features: {
    ...
    paragraphs: [
      ...
      "keystrokes save in 300ms. clicking the footer bows in to zen mode. \\time delivers a stamp. draft while scrambled to slip prying eyes or writer's block. toggle [icon:settings] and [icon:about] simultaneously for a poweruser menu.",
