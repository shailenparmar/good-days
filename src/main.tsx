...
if (MAINTENANCE && MESSAGE) {
  ...
  root.innerHTML = `<div style="display:flex;align-items:center;justify-content:center;height:100vh;padding:32px;background-color:hsl(239,70%,32%)"><p style="color:hsl(158,53%,40%);font-family:monospace;font-weight:bold;font-size:16px">${MESSAGE}</p></div>`;
} else {
