...
// Skip in Electron — file:// origin can't register service workers
...
if (MAINTENANCE && MESSAGE) {
  ...
  root.innerHTML = `<div style="display:flex;align-items:center;justify-content:center;height:100vh;padding:32px;background-color:hsl(52,100%,91%)"><p style="color:hsl(63,100%,12%);font-family:monospace;font-weight:bold;font-size:16px">${MESSAGE}</p></div>`;
} else {
