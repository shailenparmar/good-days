...
export const DEFAULT_PRESETS: ColorPreset[] = [
  ...
  { hue: 229, sat: 74, light: 82, bgHue: 252, bgSat: 78, bgLight: 47 },
  { hue: 0, sat: 37, light: 12, bgHue: 197, bgSat: 71, bgLight: 50 },
  { hue: 32, sat: 74, light: 91, bgHue: 120, bgSat: 77, bgLight: 21 },
