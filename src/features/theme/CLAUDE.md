...
**Indicator opacity (v2.6.54+):** Both hue needles and SL dots render at 0.6 opacity, matching the mobile picker. Hue needles use `rgba(0, 0, 0, 0.6)`. SL dots use `opacity: 0.6` on the element.
...
| **2** | hsl(229, 74%, 82%) lavender #afbcf3 | hsl(252, 78%, 47%) deep purple #401ad5 | — |
| **3** | hsl(347, 81%, 10%) dark crimson #2e050e | hsl(0, 80%, 42%) red #c11515 | — |
| **4** | hsl(79, 69%, 66%) yellow-green #bee46c | hsl(120, 77%, 21%) deep green #0c5f0c | — |
| **5** | hsl(289, 60%, 18%) deep plum #3f1249 | hsl(42, 59%, 34%) dark amber #8a6b24 | — |
