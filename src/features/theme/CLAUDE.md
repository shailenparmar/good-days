...
| **3** | hsl(43, 83%, 56%) gold #ecb732 | hsl(0, 100%, 23%) dark red #750000 | — |
| **4** | hsl(252, 100%, 15%) deep indigo #0f004d | hsl(180, 15%, 90%) pale grey #e2e9e9 | — |
| **5** | hsl(116, 80%, 75%) mint green #93f28c | hsl(213, 77%, 22%) dark blue #0d3463 | — |
