...
| **3** | hsl(226, 72%, 9%) dark navy #060e27 | hsl(47, 77%, 52%) golden #e3ba26 | — |
| **4** | hsl(189, 70%, 20%) dark teal #0f4c57 | hsl(124, 55%, 68%) soft green #81da87 | — |
| **5** | hsl(0, 79%, 39%) dark red #b21515 | hsl(0, 91%, 12%) very dark red #3a0303 | — |
