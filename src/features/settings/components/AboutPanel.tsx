    ...
    >
      ...
      <div className="p-4" style={sectionStyle}>
        <div className="text-base leading-relaxed font-mono font-bold space-y-4" style={{ color: getColor() }}>
          ...
          <p>
            IndexedDB = site data. so if you press "clear cookies and site data" in your browser's settings, you'll lose your entries. refreshing or quitting is safe, though; it saves automatically.
          </p>
          <p>
